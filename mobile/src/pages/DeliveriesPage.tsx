...
const styles = StyleSheet.create({
  ...
  row: { minHeight: 76, borderBottomWidth: StyleSheet.hairlineWidth, paddingHorizontal: 16, flexDirection: "row", gap: 11, alignItems: "center" },
  ...
  pressed: { opacity: 0.58, backgroundColor: "rgba(127,127,127,.08)" },
