...
const styles = StyleSheet.create({
  root: { flex: 1 }, error: { paddingHorizontal: 16, paddingTop: 10 }, list: { paddingVertical: 0 }, empty: { flexGrow: 1, alignItems: "center", justifyContent: "center", padding: 32, gap: 9 }, emptyHint: { textAlign: "center", fontSize: 12 }, row: { minHeight: 74, borderBottomWidth: StyleSheet.hairlineWidth, paddingHorizontal: 16, flexDirection: "row", gap: 11, alignItems: "center" }, icon: { width: 42, height: 42, borderRadius: 10, alignItems: "center", justifyContent: "center" }, nameRow: { flexDirection: "row", alignItems: "center", gap: 6 }, badge: { borderRadius: 7, paddingHorizontal: 6, paddingVertical: 2, fontSize: 10, overflow: "hidden" }, pressed: { opacity: 0.58, backgroundColor: "rgba(127,127,127,.08)" }, form: { gap: 13, paddingBottom: 16 }, toggle: { minHeight: 46, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
})
