...
export default function WorkspacesPage({ colors, onBack }: { colors: Palette; onBack: () => void }) {
  ...
  const saveWorkspace = async () => {
    if (!form.name.trim() || !form.model || !form.agent) { setError("请填写名称、模型和智能体"); return }
    setSaving(true)
    try {
...
const styles = StyleSheet.create({ root: { flex: 1 }, error: { paddingHorizontal: 16, paddingTop: 10 }, workspaceList: { padding: 16, gap: 10 }, empty: { flexGrow: 1, alignItems: "center", justifyContent: "center", padding: 32, gap: 9 }, emptyHint: { textAlign: "center", fontSize: 12 }, workspaceRow: { minHeight: 80, borderWidth: 1, borderRadius: 13, padding: 12, flexDirection: "row", alignItems: "center", gap: 11 }, workspaceIcon: { width: 43, height: 43, borderRadius: 11, alignItems: "center", justifyContent: "center" }, pressed: { opacity: .58, transform: [{ scale: .985 }] }, form: { gap: 14, paddingBottom: 18 }, location: { minHeight: 31, borderBottomWidth: StyleSheet.hairlineWidth, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", gap: 6 }, detail: { flex: 1, padding: 12, gap: 10 }, filePanel: { height: "34%", minHeight: 150, borderWidth: 1, borderRadius: 12, padding: 10 }, filePanelHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }, fileList: { gap: 3 }, fileRow: { minHeight: 34, borderRadius: 7, paddingHorizontal: 7, flexDirection: "row", alignItems: "center", gap: 7 }, editorPanel: { flex: 1, minHeight: 0, borderWidth: 1, borderRadius: 12, padding: 10 }, noFile: { flex: 1, alignItems: "center", justifyContent: "center", gap: 10, padding: 20 }, editorHeader: { height: 39, flexDirection: "row", gap: 8, marginBottom: 8 }, fileName: { flex: 1, borderRadius: 8, paddingHorizontal: 10, fontSize: 13 }, saveFile: { width: 42, borderRadius: 8, alignItems: "center", justifyContent: "center" }, codeEditor: { flex: 1, minHeight: 180, borderRadius: 9, padding: 10, fontFamily: "monospace", fontSize: 13, lineHeight: 20 } })
