...
func EnsureDefaultSystemSettings() error {
	...
	defaults := map[string]string{
		...
		"advanced_chat_file_storage_enabled":         "true",
		"advanced_chat_file_storage_total_mb":        "1024",
		"advanced_chat_scheduled_tasks_enabled":      "true",
		"advanced_chat_message_delivery_enabled":     "true",
		"advanced_chat_delivery_system_smtp_enabled": "true",
		"redis_enabled":                              "false",
