...
func CreateEnterpriseConnectorToken(db *gorm.DB, userID uint, name, mode string) (AdvancedChatConnectorDevice, string, error) {
	if db == nil || userID == 0 {
