...
const demoAdapter: AxiosAdapter = async (config) => {
  ...
  if (path === "/user/advanced-chat/settings") return demoResponse(config, { file_storage_enabled: true, assistant_mode_enabled: true, assistant_mcp_tools_enabled: true, assistant_connector_list_files_enabled: true, assistant_connector_read_file_enabled: true, assistant_connector_write_file_enabled: true, assistant_connector_replace_text_enabled: true, assistant_connector_run_command_enabled: true, assistant_connector_web_search_enabled: true, mcp_servers: [], builtin_mcp_servers: [], custom_mcp_servers: [] });
