...
export default defineConfig({
  ...
  resolve: { alias: [
    ...
    { find: "lucide-react", replacement: "/dashboard-icons.js" },
  ...
  build: {
    ...
    emptyOutDir: false,
    lib: {
      entry: path.resolve(root, "public.ts"),
      formats: ["es"],
      fileName: () => "dashboard-public.js",
    },
    rollupOptions: { external: [vendor, "/dashboard-icons.js"] },
  },
})
