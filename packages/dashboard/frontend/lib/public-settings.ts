export interface PublicSettings {
  ...
  page_layouts: string
  // Palette customisations, not defaults. `frontend/index.css` owns the shipped
  // palette; an empty value here means "use the stylesheet", and only a value
  // somebody actually configured is written back as an override.
...
export const defaultPublicSettings: PublicSettings = {
  ...
  theme_light_card: "",
  theme_light_card_foreground: "",
  theme_light_primary: "",
  theme_light_primary_foreground: "",
  theme_light_secondary: "",
  theme_light_secondary_foreground: "",
  theme_light_accent: "",
  theme_light_accent_foreground: "",
  theme_light_muted: "",
  theme_light_muted_foreground: "",
  theme_light_border: "",
  theme_dark_background: "",
  theme_dark_foreground: "",
  theme_dark_card: "",
  theme_dark_card_foreground: "",
  theme_dark_primary: "",
  theme_dark_primary_foreground: "",
  theme_dark_secondary: "",
  theme_dark_secondary_foreground: "",
  theme_dark_accent: "",
  theme_dark_accent_foreground: "",
  theme_dark_muted: "",
